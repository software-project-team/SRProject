...
public class FirebaseMethods {
    ...
    public void uploadNewPhoto(String photoType, final String caption,final int count, final String imgUrl,
        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))){
            ...
            if(bm == null){
                bm = com.yunuscagliyan.socialreader.Utils.ImageManager.getBitmap(imgUrl);
            }

            byte[] bytes = com.yunuscagliyan.socialreader.Utils.ImageManager.getBytesFromBitmap(bm, 100);
     ...
     */
        public UserSettings getUserSettings(DataSnapshot dataSnapshot){
            Log.d(TAG, "getUserAccountSettings: retrieving user accont settings from firebase");
